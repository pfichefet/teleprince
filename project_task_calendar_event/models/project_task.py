...
class ProjectTask(models.Model):
    ...
    def write(self, vals):
        ...
        if any([field in vals for field in ['name', 'project_id', 'description', 'date_deadline', 'planned_date_begin', 'user_ids', 'partner_id']]) and not self.env.context.get('task_event', False):
            for task in self:
