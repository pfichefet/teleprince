...
class CalendarEvent(models.Model):
    ...
    def create(self, vals_list):
        ...
        If a project is set on a calendar event, create a new task
        """
        events = super(CalendarEvent, self.with_context(task_event=True)).create(vals_list)
    ...
    def write(self, vals):
        ...
        if 'project_id' in vals and vals.get('project_id', False) and event_without_tasks:
