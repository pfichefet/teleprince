...
class Mail(models.Model):
    ...
    def remove_powered_by_odoo(self, body):
        """
        Method is responsible to remove the Powered by Odoo from body message
        ...
        # Find the <p> tag with the specific link URL
        p_elements = tree.xpath('//p[a/@href="https://www.odoo.com?utm_source=db&utm_medium=email"]')

        # Remove the found <p> element
        for p_element in p_elements:
            p_element.getparent().remove(p_element)

        # Get the modified HTML
        modified_html = html.tostring(tree, encoding='unicode')
        return modified_html

    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        """
        Call "remove_powered_by_odoo" method with parameter body to modify body and remove powered by odoo.
        :param auto_commit: Auto Commit
        :param raise_exception: Raise an exceptions
        :param smtp_session: SMTP Session ID
        :return: True
        """
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                body = mail.remove_powered_by_odoo(body)
